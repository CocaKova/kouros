        ...
        if (servers.isEmpty()) {
            Column(Modifier.fillMaxSize(), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
                EmptyState(
                    ...
                    "Point Pygmalion at the ComfyUI server you already run — on your desktop, a home server or a cloud GPU. Everything stays between your phone and your server.",
