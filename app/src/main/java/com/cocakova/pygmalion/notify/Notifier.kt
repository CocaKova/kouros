package com.cocakova.pygmalion.notify
...
import com.cocakova.pygmalion.R
 ...
 */
class Notifier(private val app: PygmalionApp) {
    ...
    fun live(runs: List<RunProgress>, names: Map<String, String>, preview: Bitmap?): Notification {
        ...
        if (Build.VERSION.SDK_INT >= 36 && lead != null) {
            val style = Notification.ProgressStyle()
                ...
                .setProgressTrackerIcon(Icon.createWithResource(app, R.drawable.ic_stat_pygmalion))
            ...
            val b = Notification.Builder(app, CH_LIVE)
                .setSmallIcon(R.drawable.ic_stat_pygmalion)
