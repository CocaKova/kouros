...
private val DarkScheme = darkColorScheme(
    ...
    // Selection (nav pill, chips, tabs) stays in the clay family; verdigris is kept for "it worked".
    secondary = Accent.clayBright,
    onSecondary = Stone.s0,
    secondaryContainer = Color(0xFF2E1F17),
    onSecondaryContainer = Accent.ember,
    tertiary = Accent.ember,
    onTertiary = Stone.s0,
    tertiaryContainer = Stone.s4,
    onTertiaryContainer = Accent.ember,
    surfaceTint = Accent.clay,
    inverseSurface = Stone.bone,
    inverseOnSurface = Stone.s1,
    inversePrimary = Accent.clayDeep,
    background = Stone.s0,
...
private val LightScheme = lightColorScheme(
    ...
    secondary = Accent.clayDeep,
    onSecondary = Carrara.slab,
    secondaryContainer = Color(0xFFF6DCCD),
    onSecondaryContainer = Color(0xFF4A1F0E),
    tertiary = Accent.clay,
    onTertiary = Carrara.slab,
    tertiaryContainer = Carrara.vein,
    onTertiaryContainer = Color(0xFF4A1F0E),
    surfaceTint = Accent.clayDeep,
    inverseSurface = Carrara.graphite,
    inverseOnSurface = Carrara.floor,
    inversePrimary = Accent.clayBright,
