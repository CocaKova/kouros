package com.cocakova.kouros.widget
...
import com.cocakova.kouros.quick.QuickRunActivity
 ...
 */
class KourosWidget : GlanceAppWidget() {
    ...
    companion object {
        suspend fun refresh(context: Context) = runCatching { KourosWidget().updateAll(context) }
    }
}

class KourosWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = KourosWidget()
}
