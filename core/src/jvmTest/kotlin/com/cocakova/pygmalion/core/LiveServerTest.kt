 ...
 * with history, fetch the result. Skipped unless PYG_LIVE_SERVER and PYG_LIVE_WORKFLOW are set.
 */
class LiveServerTest {
    @Test
    fun runsAWorkflowEndToEnd() = runBlocking {
        val server = System.getenv("PYG_LIVE_SERVER") ?: return@runBlocking
        val wfPath = System.getenv("PYG_LIVE_WORKFLOW") ?: return@runBlocking
        ...
        val text = System.getenv("PYG_LIVE_PROMPT") ?: "a small clay figure on a stone plinth in a sunlit sculptor's studio, soft light"
